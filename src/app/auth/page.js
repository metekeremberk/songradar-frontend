...
import { onSignUp, onSignIn } from "./actions";
	...
	return (
		<div className="h-auto w-80 bg-white flex flex-col items-stretch justify-evenly p-10">
			...
			<form action={formAction} className="flex flex-col gap-2">
				...
				{errorMessage === null && (
					<p className="px-0 border-none text-green-600 text-xs">
						Successfully created account. Sign in to start your SongRadar
						experience!
					</p>
				)}
				<button type="submit" className="border px-4 py-2 rounded">
